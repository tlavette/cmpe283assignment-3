...
static int __vmx_handle_exit(struct kvm_vcpu *vcpu, fastpath_t exit_fastpath)
{
	...
	extern u32 exit_counts[69];
	extern uint64_t cpu_cycles_counter[69];

	start_time = rdtsc();

	u32 exit_no = vmx->exit_reason.basic;
	...
	elapsed_time = rdtsc();
	cpu_cycles_counter[exit_no] = cpu_cycles_counter[exit_no] + elapsed_time - start_time;
	cpu_cycles += elapsed_time - start_time;
